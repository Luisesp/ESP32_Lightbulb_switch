 ...
 */
void HandleUpdatedState(HAPAccessoryServerRef* _Nonnull server, void* _Nullable context) {
     ESP_LOGW("app_Main", "HandleUpdatedState $$$$$$$");
...
void main_task()
{
    ...
    ESP_LOGW(TAG, "HAPPlatformRunLoopRun - starting next");
    HAPPlatformRunLoopRun();
    ESP_LOGW(TAG, "HAPPlatformRunLoopRun");
